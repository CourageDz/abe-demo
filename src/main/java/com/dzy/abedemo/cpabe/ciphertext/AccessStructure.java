...
public class AccessStructure implements Serializable {
    ...
    private Map<Integer, AttElement> rho;
    ...
    private void generateMatrix() {
        ...
        while (!queue.isEmpty()) {
            ...
            if (node instanceof InternalNode) {
                ...
                AttElement att = new AttElement(node.getName(), ((Attribute) node).isTimeLimited());
//                rho.put(A.size(), node.getName());
    ...
    public static void main(String[] args) {
        AccessStructure as = AccessStructure.buildFromPolicy("and and a b or c and d e");
        ...
        attributes.add("d");
        attributes.add("e");
        List<Integer> indexs = as.getIndexesList(attributes);
